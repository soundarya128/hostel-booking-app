...
@theme inline {
  --font-heading: var(--font-playfair), 'Playfair Display Fallback';
  --font-serif: var(--font-playfair), 'Playfair Display Fallback';
...
:root {
  ...
  --primary: oklch(0.33 0.05 155);
  --primary-foreground: oklch(0.98 0.008 90);
  --secondary: oklch(0.94 0.015 90);
  --secondary-foreground: oklch(0.33 0.05 155);
  ...
  --input: oklch(0.88 0.015 90);
  --ring: oklch(0.33 0.05 155);
  --chart-1: oklch(0.33 0.05 155);
  --chart-2: oklch(0.72 0.11 75);
  --chart-3: oklch(0.5 0.06 150);
  --chart-4: oklch(0.62 0.09 80);
  --chart-5: oklch(0.42 0.04 155);
  --radius: 0.375rem;
  --sidebar: oklch(0.98 0.008 90);
  --sidebar-foreground: oklch(0.22 0.02 150);
  --sidebar-primary: oklch(0.33 0.05 155);
  --sidebar-primary-foreground: oklch(0.98 0.008 90);
  --sidebar-accent: oklch(0.72 0.11 75);
  --sidebar-accent-foreground: oklch(0.22 0.02 150);
  --sidebar-border: oklch(0.88 0.015 90);
  --sidebar-ring: oklch(0.33 0.05 155);
}
